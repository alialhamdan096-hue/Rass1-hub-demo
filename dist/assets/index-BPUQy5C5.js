...
// Override request to use POST when data is provided
v.request=async function(t,e=null){
    try{
        let n=f.API_URL;
        let o={};
        if(e){
            o={method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:t,data:e})};
        }else{
            n+="?action="+t;
        }

...
.modal-title { font-size: 18px; font-weight: bold; color: var(–text-dark); margin-bottom: 10px; }
.modal-message { color: var(–gray); margin-bottom: 20px; line-height: 1.6; }
...
.modal-cancel { background: #e5e5e5; color: var(–text-dark); }
...
.modal-confirm.success { background: var(–success); }
.modal-confirm.success:hover { background: #059669; }
...
.error-message { color: var(–danger); font-size: 11px; margin-top: 3px; display: none; }
...
.btn-primary:hover:not(:disabled) { background: var(–primary-light); transform: translateY(-2px); box-shadow: var(–shadow-md); }
...
.phone-copy { cursor: pointer; padding: 2px 5px; border-radius: 4px; transition: var(–transition); }
.phone-copy:hover { background: #e5e5e5; }
...
.wa svg { width: 18px; height: 18px; fill: white; }
...
.arrived { background: rgba(59,130,246,0.15); color: var(–info); }
.done { background: rgba(141,198,63,0.15); color: var(–accent-dark); }
...
.stat-num { font-size: 24px; font-weight: 800; color: var(–text-dark); }
.stat-label { color: #888; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 3px; }
...
.stat.orders::after { background: var(–info); }
...
.alert-banner-text { flex: 1; font-weight: 500; color: #92400e; font-size: 13px; }
.alert-banner-close { background: none; border: none; font-size: 18px; cursor: pointer; color: #92400e; padding: 5px; }
...
.track-card .name { font-size: 15px; margin-bottom: 4px; color: #333; }
.track-card .med { margin: 8px 0; color: var(–primary); font-size: 13px; }
.track-card .info { font-size: 11px; color: #888; margin-bottom: 12px; line-height: 1.4; }
...
.report-value { font-size: 36px; font-weight: bold; color: var(–primary); }
.report-label { font-size: 12px; color: #888; margin-top: 4px; }
...
.tabs, .sync, .header-row button, .actions, .pagination, .filters-row select, .alert-banner, .type-selector { display: none !important; }
